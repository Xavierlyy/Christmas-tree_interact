...
<img width="714" height="1313" alt="image" src="https://github.com/user-attachments/assets/0f1bebe9-8a68-489d-935e-6eab0f52a400" />
...
| 手势图标 | 手势名称 | 功能 (Action) | 效果描述 |
| :---: | :--- | :--- | :--- |
| 🖐 | **Open Palm (张开手掌)** | **Disperse (散开)** | 圣诞树炸裂成漫天飞舞的粒子和照片，进入 Chaos 模式。 |
| ✊ | **Closed Fist (握紧拳头)** | **Assemble (聚合)** | 所有元素瞬间聚合成一棵完美的圣诞树，进入 Formed 模式。 |
| ✌️ | **Victory (比耶/剪刀手)** | **Zoom In (放大)** | 照片会放大显示，方便查看细节。 |
| 👍 | **Thumb Up (点赞)** | **Memory Mode (回忆)** | 随机抽取三张照片单独高亮展示，带你重温美好瞬间。 |
| 👋 | **Hand Move (手掌移动)** | **Rotate (旋转视角)** | 左右移动手掌可控制圣诞树旋转。 |
### ⚙️ 进阶配置
